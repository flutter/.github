...
3. Help out as described in our docs: https://github.com/flutter/flutter/blob/master/docs/triage/README.md
...
4. Familiarize yourself with our
   [issue hygiene](https://github.com/flutter/flutter/blob/master/docs/contributing/issue_hygiene/README.md) docs page,
...
5. Once you've been doing this for a while, someone will invite you to the flutter-hackers
   ...
   [contributor access](https://github.com/flutter/flutter/blob/master/docs/contributing/Contributor-access.md) docs
   page for details.
